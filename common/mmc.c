...
#define CS_LOW()	SD_CS_PORT &= ~(1<<SD_CS_PIN)/* CS=low */
#define CS_HIGH()	SD_CS_PORT |=  (1<<SD_CS_PIN)/* CS=high */
#define SOCKINS		(!(PINC & 0x20))	/* Card detected.   yes:true, no:false, default:true */
#define SOCKWP		(PINC & 0x10)		/* Write protected. yes:true, no:false, default:false */
